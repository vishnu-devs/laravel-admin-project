...
Route::group(['namespace' => 'App\Http\Controllers\Backend', 'prefix' => 'admin', 'as' => 'backend.', 'middleware' => ['auth', 'can:view_backend']], function () {
    ...
    Route::post('/import-csv', 'CsvImportController@store')->name('importcsv');
    ...
    */
    ...
    $module_name = 'paymentreminder';
    $controller_name = 'PaymentReminderController';
    Route::get("$module_name", "$controller_name@index")->name("$module_name");
    Route::get("$module_name/send/{id}", "$controller_name@send")->name("$module_name.send");
    ...
    */
    ...
    $module_name = 'dailyrates';
    $controller_name = 'DailyRatesController';
    Route::get("$module_name", "$controller_name@index")->name("$module_name");
    Route::post("$module_name", "$controller_name@send")->name("$module_name.send");
