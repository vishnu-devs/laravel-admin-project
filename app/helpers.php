...
if (! function_exists('bn2enNumber')) {
    ...
    function bn2enNumber($number)
    {
        ...
        $en_number = str_replace($search_array, $number);
...
if (! function_exists('en2bnNumber')) {
    ...
    function en2bnNumber($number)
    {
        ...
        $bn_number = str_replace($search_array, $number);
 ...
 *
 * banglaDate
 * By default, it will return today's date
 *
 * ------------------------------------------------------------------------
 */
if (! function_exists('banglaDate')) {
    function banglaDate($date_input = '')
    {
        ...
        $return_bn_date = $en_day.' '.$en_month.' '.$en_year;
